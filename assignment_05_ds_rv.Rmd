...
- Statistical tests show inconclusive evidence that any strong relationships exist between 1)forest section and where the Pacific Giant Salamander are found, 2) weights the salamanders across forest sections, and 3) weights of the salamanders across channel classifications. (Results B, C, D, & E)
- Despite statistical outcomes, mean weight of Pacfic Giant Salamanders sampled in clear-cut forests are 1.2 grams larger (~18% larger) than those sampled in old growth forest sections.(Figure 2) Furthermore, in clear cut sections, there is a larger proportion in cascades and a smaller proportion in pools.(Table 1)
