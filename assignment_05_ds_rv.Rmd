...
Nestled alongside Oregon's forest-dense McKenzie River, Mack Creek is home to the Pacific Giant Salamander. 

Forest sections along Mack Creek, which is a part of the H.J. Andrews Experimental Forest, have been clear-cut. It is not fully understood whether or not the clear-cutting of the forest has a significant impact on the Pacific Giant Salamander population. Since 1993, Pacific Giant Salamanders have been monitored in both a clear-cut forest section and a 500-year-old, old-growth coniferous forest section. two forest sections along Mack Creek, within the H.J. Andrews Experimental Forest. Observations of Pacific Giant Salamander's also includes the specific location where Pacific Giant Salamanders were found in the channel. Here, we analyze the 

The results of this analysis sheds light on the relationship that exists between forest section and Pacific Giant Salamanders in Mack Creek.
...
ggplot(data = mack_creek_count, aes(x = year, y = count, group = section_name))+
  ...
  theme_light()
```
**Figure 1**: *Counts of Pacific Giant Salamander’s compared between clear-cut forest section and old-growth forest section between 1993 and 2017. Visually, there is little difference between the counts of Pacific Giant Salamanders in clear cut and old growth forest sections.*
...
**Table 1:** *2017 Salamander counts by channel classification (pool, cascades, and side-channel) in old-growth and clear-cut sections of Mack Creek. Proportions provide slight indication of the effect that forest section has on the channel section where Pacific Giant Salamanders are found.*
```{r, fig.align = 'center'}
